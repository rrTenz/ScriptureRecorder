...
class ViewController_SubBook: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    {
        return Const.SUB_BOOK_LIST[appDelegate.userLanguage.rawValue][appDelegate.bookEnum.rawValue].count
    }
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        case Const.BOM, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.BOM.rawValue] :
            cell.textLabel?.text = Const.BOM_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.PGP, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.PGP.rawValue]:
            cell.textLabel?.text = Const.PGP_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.DC, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.DC.rawValue]:
            cell.textLabel?.text = Const.DC_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.OT, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.OT.rawValue]:
            cell.textLabel?.text = Const.OT_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.NT, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.NT.rawValue]:
            cell.textLabel?.text = Const.NT_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        default:
            cell.textLabel?.text = "???"
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch appDelegate.bookString {
        case Const.BOM, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.BOM.rawValue]:
            appDelegate.subBookString = Const.BOM_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.PGP, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.PGP.rawValue]:
            appDelegate.subBookString = Const.PGP_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.DC, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.DC.rawValue]:
            appDelegate.subBookString = Const.DC_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.OT, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.OT.rawValue]:
            appDelegate.subBookString = Const.OT_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        case Const.NT, Const.BOOK_LIST[appDelegate.userLanguage.rawValue][Const.Book.NT.rawValue]:
            appDelegate.subBookString = Const.NT_LIST[appDelegate.userLanguage.rawValue][indexPath.row]
        default:
